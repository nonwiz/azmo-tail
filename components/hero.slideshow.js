...
const content = (
  <span>
    Lifestyle, Vlogging, & Blogging,
    <br /> and Tips about Health
  </span>
);
      ...
      <Slide easing="ease">
        {slides.map((item) => (
          <div className="each-slide container mx-auto z-auto" key={item.title}>
            ...
            >
              <div className="md:w-1/2 mx-auto text-center sm:h-40 flex flex-col justify-center bg-white bg-opacity-50 md:bg-opacity-50 rounded-xl px-2">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold font-extrabold gagalin text-name text-name">
