              ...
              <a href="https://www.instagram.com/azmo.page/" target="_blank">
                ...
                >
                  ...
                  >
                   ...
                   <a href="https://pinterest.com/Azlasorubou" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                    fill="currentColor"
                    className="bi bi-instagram mx-auto border border-lg rounded-full text-white hover:text-rose-300 hover:border-rose-300 "
                    viewBox="0 0 16 16"
                  >
                    <text x="2" y="15"> P </text>
                  </svg>
                </a>
